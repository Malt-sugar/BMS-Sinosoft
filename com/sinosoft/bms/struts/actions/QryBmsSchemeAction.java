...
public class QryBmsSchemeAction extends CitiQueryAction{

	public ActionForward citiExecute(ActionMapping actionMapping,
			ActionForm actionForm, HttpServletRequest request,
			HttpServletResponse httpServletResponse) throws Exception {
		
		AddBudgetSchemeFrom shceForm = (AddBudgetSchemeFrom) actionForm;
		BmsSchemeObj bmsObjBean = (BmsSchemeObj) BeanFactory.getBean("BmsSchemeObj");
		SSRS ssrs  = bmsObjBean.queryBmsScheme(shceForm.getBmsScheme(),shceForm.getBgObjID());
