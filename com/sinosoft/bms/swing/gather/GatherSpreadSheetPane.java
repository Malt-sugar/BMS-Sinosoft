 ...
 *
 */
public class GatherSpreadSheetPane extends DesignSpreadSheetPane {

	/**
	 * 
	 */
	public GatherSpreadSheetPane() {
	}

	/**
	 * @param spreadsheet
	 */
	public GatherSpreadSheetPane(SpreadSheet spreadsheet) {
		super(spreadsheet);
	}
	 ...
	 * @param grid
	 */
	public GatherSpreadSheetPane(SpreadSheet spreadsheet, Grid grid) {
