 ...
 *
 */
public class GatherSheetPanel extends JPanel {

	
	public GatherGrid inputGrid = new GatherGrid();
	public GatherSpreadSheetPane sheetPanel = new GatherSpreadSheetPane(new SpreadSheet(),inputGrid);
...
//					result = ((Double)bsh.get("result")).doubleValue();
					...
					report.removeCellElement(col, row);
